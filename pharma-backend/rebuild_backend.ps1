...
$backendDir = "c:\Pharma_Final_Projectt (2) (2)\Pharma_Final_Projectt (2)\Pharma_Final_Projectt\Pharma_Final_Project\Backend"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "java -jar target/farma-track-backend-0.0.1-SNAPSHOT.jar --server.port=8082" -ForegroundColor Yellow
} else {
