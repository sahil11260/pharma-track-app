...
public class DoctorController {
    ...
    @GetMapping("/{id}")
    public DoctorResponse get(@PathVariable(value = "id") Long id) {
    ...
    @PutMapping("/{id}")
    public DoctorResponse update(@PathVariable(value = "id") Long id, @Valid @RequestBody UpdateDoctorRequest request) {
